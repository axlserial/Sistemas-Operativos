/****  Programa para mostrar el uso de semáforos en la sincronización de procesos, tomado de la página 389 del libro de: UNIX Programación Avanzada. F.M. Márquez ******/
#include <stdio.h>
#include <stdlib.h>
#include <sys/types.h>
#include <sys/ipc.h>
